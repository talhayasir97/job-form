                        ...
                        <form action="{{route('update_student',$student->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="card">
                                    ...
                                    <h4 class="pt-3">Update Student</h4>
                                    </div>
                                    <h4 class="brand-name text-center py-3">
                                    Welcome to the ANGELS School System Student Updation
                                    Form
                                    </h4>
                                    <div class="card-body">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                        <label>Session</label>
                                        <input type="text" class="form-control" name="session" value="{{$student->session}}" id="session"/>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                        <label>B-Form</label>
                                        <input type="text" id="b_form" name="b_form" value="{{$student->b_form}}" class="form-control" maxlength="15"/>
                                        </div>

                                        <div class="form-group col-md-6">
                                        <label>Select Class</label>
                                        <select class="form-control" name="class" value="{{$student->class}}" id="class">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <input type="text" class="form-control" name="father_name" value="{{$student->father_name}}" id="father_name"/>
                                        </div>
                                        <div class="form-group col-md-6">
                                        <label>Father Business</label>
                                        <input type="text" class="form-control" name="father_buisness" value="{{$student->father_buisness}}" id="father_buisness"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <input type="text" class="form-control" id="father_cnic" name="father_cnic" value="{{$student->father_cnic}}" maxlength="15"/>
                                        </div>
                                        <div class="form-group col-md-6">
                                        <label>Contact Number</label>
                                        <input type="text" class="form-control" id="contact_number" name="contact_number" value="{{$student->contact_number}}" maxlength="11"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <select class="form-control" name="nationality" id="nationality" value="{{$student->nationality}}">
                                        ...
                                        <select class="form-control" name="religion" id="religion" value="{{$student->religion}}">
                                            <option>Islam</option>
                                            <option>Hindu</option>
