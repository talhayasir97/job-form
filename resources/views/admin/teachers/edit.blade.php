                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-header">
                      <h4 class="py-3">Update Teacher</h4>
                    </div>
                    <h4 class="brand-name text-center py-3">
                      Welcome to the ANGEL School System Teacher Updation
                      Form
                    </h4>
                    <div class="card-body">
                      ...
                      <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" class="form-control" name="contact_number" value="{{$teacher->contact_number}}" />
                        </div>
                      </div>
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-6">
                          ...
                          <select class="form-control" name="nationality" value="{{$teacher->nationality}}" >
